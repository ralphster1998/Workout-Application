...
var index_module = __webpack_require__(739);
var index_module_default = /*#__PURE__*/__webpack_require__.n(index_module);
// EXTERNAL MODULE: ./pages/Card.js
var Card = __webpack_require__(932);
...
const store = (initialState = startState) => {
  return (0,external_redux_namespaceObject.createStore)(reducer, initialState);
}; // wrapper that simplifies all redux code


const initStore = (0,external_next_redux_wrapper_namespaceObject.createWrapper)(store);
/*
Actions:
  ...
  render() {
    return /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx("header", {
        ...
        className: (index_module_default()).grid,
        children: this.props.cards.map(card => /*#__PURE__*/jsx_runtime_.jsx(Card.default, {}, card.id))
      })]
    });
  }
...
/* harmony default export */ var pages = (initStore.withRedux(Index));
/*
UPDATE 06/29/2021:
...
var __webpack_exports__ = __webpack_require__.X(0, [664,932], function() { return __webpack_exec__(784); });
